...
/** A plan priced in `currency`; see {@link createProductBlockDefinition}. */
export const createOfferBlockDefinition = <Currency extends string>(
	currency: Currency,
): EmailBlockDefinition<EmailEditorOfferBlock<Currency>> => ({
	type: "offer",
	label: "Offer",

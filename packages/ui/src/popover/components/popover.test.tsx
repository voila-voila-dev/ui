...
function Fixture(props: React.ComponentProps<typeof Popover.Content>) {
	return (
		<Popover.Root>
			...
			<Popover.Content {...props}>
				<Popover.Header>
					<Popover.Title>Q3 brand refresh</Popover.Title>
					<Popover.Description>
						Kickoff call — June 14, from 14:00 to 18:00.
					</Popover.Description>
				</Popover.Header>
				<Popover.Close render={<Button variant="ghost" />}>Close</Popover.Close>
			</Popover.Content>
		</Popover.Root>
	);
}

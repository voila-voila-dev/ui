...
import { DataTableDesktopTable } from "#/datatable/components/data-table-desktop-table.tsx";
import { DataTableMobileCardList } from "#/datatable/components/data-table-mobile-card-list.tsx";

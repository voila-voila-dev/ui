...
import type { MessageScrollerRefs } from "#/chat/hooks/use-message-scroller-refs.ts";
import {
	getElementScrollTop,
...
import type { MessageScrollerScrollOptions } from "#/chat/lib/message-scroller-types.ts";
import {

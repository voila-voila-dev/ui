...
function renderCarousel(
	props: React.ComponentProps<typeof Carousel.Root> = {},
		...
		>
			<Carousel.Content>
				{[1, 2, 3].map((slideNumber) => (
					<Carousel.Item key={slideNumber}>Slide {slideNumber}</Carousel.Item>
				))}
			</Carousel.Content>
			<Carousel.Previous />
			<Carousel.Next />
			{options.withDots ? <Carousel.Dots /> : null}
		</Carousel.Root>,
	);
	return {
		screen,
...
describe("Carousel.Previous / Carousel.Next", () => {

...
export type { LandingHeroLayoutVariants } from "#/landing/components/landing-hero-variants.ts";
export { landingHeroLayoutOptions } from "#/landing/components/landing-hero-variants.ts";

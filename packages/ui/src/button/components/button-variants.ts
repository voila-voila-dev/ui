...
export const buttonVariants = cva({
	...
	variants: {
		/**
		 * Weight of the action. `default` is the one thing the page exists for, at
		...
		/**
		 * Height and horizontal padding. The `icon-*` set is square, for a button
		...
		/**
		 * `pill` forces a fully rounded button; `default` follows the theme's

...
description: "Override the CSS custom properties in @voila.dev/ui/design-tokens.css to rebrand the whole system without forking a single component."
---

import Preview from "@/components/docs/preview";
import * as Example from "../../../examples/theming";

The palette that ships with `@voila.dev/ui/design-tokens.css` is a **default, not a

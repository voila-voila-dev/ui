...
import * as Example from "@/examples/ui-landing/section-intro";
...
<PropTable of="SectionIntro.Root" />

### SectionIntro.Description

<PropTable of="SectionIntro.Description" />

### SectionIntro.Title

<PropTable of="SectionIntro.Title" />
